...
class RobotMap {
    ...
    public static void init(){
        ...
        MAIN_LEFT_DRIVE = new WPI_TalonSRX(Constants.DriveConstants.TALONSRX_LEFT_1);
        MAIN_RIGHT_DRIVE =  new WPI_TalonSRX(Constants.DriveConstants.TALONSRX_RIGHT_1);

        SUB_LEFT_DRIVE = new WPI_TalonSRX(Constants.DriveConstants.TALONSRX_LEFT_2);
        SUB_RIGHT_DRIVE = new WPI_TalonSRX(Constants.DriveConstants.TALONSRX_RIGHT_2);
